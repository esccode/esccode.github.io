...
- **Configuration management**
  - Diagrams
  - Baseline configuration(is the process of identifying and 
documenting all aspects of an asset’s configurations to create a secure template against which all subsequent configurations 
are measured.)
...
- Non-persistence
  ...
  - Live boot media
- High availability(The` ability to keep services up and running` for long periods of time. Uses multiple systems to protect against service failure.)
