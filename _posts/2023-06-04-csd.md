...
- Multifactor authentication(MFA) factors and attributes
  ...
  - Attributes
    ...
    - Someone you know
- Authentications authorization, and accounting(AAA)(Authorization is the term for intelligently controlling access to computer resources, enforcing policies, auditing usage, and providing the information necessary to bill for services)
