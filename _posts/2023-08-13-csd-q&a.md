...
**`3`**  
3DES is a more secure version of DES and is still implemented in some situations, although it has since been superseded `by more secure algorithms such as AES-256 and XChaCha20 1`. The key length of 3DES is `168 bits`, which is three times the key length of DES.
...
**RC4 (Rivest Cipher 4)** is a stream cipher that was designed by Ron Rivest of RSA Security in 1987 1. It is a symmetric-key algorithm, meaning the same key is used for both encryption and decryption.
