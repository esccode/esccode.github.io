...
Correct, When you earn all three of these certifications, you are named a CompTIA Security Analytics Expert and you can use the CSAE title.

- How should you best prepare for the Security+ exam?
Study using a diverse set of resources.
Correct, There are multiple resources you should use to study for this exam, including the book, practice questions, and study groups.
