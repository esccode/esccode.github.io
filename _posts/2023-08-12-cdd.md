...
- **Data outliers**(Values in the data set that don't seem to be within the norm of all the other data. To identify outliers is easy to use visualization tool "Boxplot")
