...
- **Recoding data**
  - *Numeric*
  - *Categorical*
- **Derived variables**(is a data point that is “derived” or created from existing data.`SELECT OneColums, SecondColumn, DATEIF(dd, Birtdday, GETDATE()) FROM database.table`)
