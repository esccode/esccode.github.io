...
- **Type of analysis**(defined by measuring a trend on historical data to predict a future outcome)
  ...
  - *Link analysis*(is used to determine how a single data point links to other data points, focusing on the relationships and connections in a database. Link analysis has three main components: a network, a node, and a link. s)
