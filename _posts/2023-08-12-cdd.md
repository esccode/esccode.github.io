...
- **Pie chart**(a `circle broken into slices` to represent percentages of information. The pie chart is easy to understand and thus is commonly used. Wedge percentages add up to 100%.)
